            ...
            <div class="container container_h100">
                <div class="why__services_wrapp">
                    <h2 class="photo__title">
                        ...
                        <span class="photo__title_black">Проекты</span>
                        ...
                        <div class="gallery">
                            ...
                            <div class="slider">
                                <ul class="slider__list slider__list_photo" date_1="0">
                                    ...
                                    <?php if (have_rows('dek-sv')) : ?>
                                        <?php while (have_rows('dek-sv')) : the_row(); ?>
                                            <li class="slider__item slider_photo mix dek-sv slider_photo_active" data_1="0">
                                    ...
                                    <?php if (have_rows('клубный_и_тв_декор')) : ?>
                                        <?php while (have_rows('клубный_и_тв_декор')) : the_row(); ?>
                                            <li class="slider__item slider_photo mix club slider_photo_active" data_1="0">
                                                <img src="<?php echo get_sub_field('фото'); ?>" alt="photo" class="slider__img pop-up-img">
                                    ...
                                    <?php if (have_rows('декор_для_фотосессий')) : ?>
                                        <?php while (have_rows('декор_для_фотосессий')) : the_row(); ?>
                                            <li class="slider__item slider_photo mix dek-photo slider_photo_active" data_1="0">
                                                <img src="<?php echo get_sub_field('фото'); ?>" alt="photo" class="slider__img pop-up-img">
                                    ...
                                    <?php if (have_rows('дизайн_интерьера')) : ?>
                                        <?php while (have_rows('дизайн_интерьера')) : the_row(); ?>
                                            <li class="slider__item slider_photo mix diz-interier slider_photo_active" data_1="0">
                                                <img src="<?php echo get_sub_field('фото'); ?>" alt="photo" class="slider__img pop-up-img">
                                    ...
                                    <?php if (have_rows('арт_перфоманс')) : ?>
                                        <?php while (have_rows('арт_перфоманс')) : the_row(); ?>
                                            <li class="slider__item slider_photo mix art-perf slider_photo_active" data_1="0">
                                                <img src="<?php echo get_sub_field('фото'); ?>" alt="photo" class="slider__img pop-up-img">
                                    ...
                                    <?php if (have_rows('роспись_стен')) : ?>
                                        <?php while (have_rows('роспись_стен')) : the_row(); ?>
                                            <li class="slider__item slider_photo mix write-wall slider_photo_active" data_1="0">
                                                <img src="<?php echo get_sub_field('фото'); ?>" alt="photo" class="slider__img pop-up-img">
                                    ...
                                    <?php if (have_rows('аренда_готовых_декораций')) : ?>
                                        <?php while (have_rows('аренда_готовых_декораций')) : the_row(); ?>
                                            <li class="slider__item slider_photo mix rent-got slider_photo_active" data_1="0">
                                                <img src="<?php echo get_sub_field('фото'); ?>" alt="photo" class="slider__img pop-up-img">
                                    ...
                                    <?php if (have_rows('декор_детских_мероприятий')) : ?>
                                        <?php while (have_rows('декор_детских_мероприятий')) : the_row(); ?>
                                            <li class="slider__item slider_photo mix dekor-child slider_photo_active" data_1="0">
                                                <img src="<?php echo get_sub_field('фото'); ?>" alt="photo" class="slider__img pop-up-img">
                                    ...
                                    <?php if (have_rows('новогодний_декор')) : ?>
                                        <?php while (have_rows('новогодний_декор')) : the_row(); ?>
                                            <li class="slider__item slider_photo mix new-year slider_photo_active" data_1="0">
                                                <img src="<?php echo get_sub_field('фото'); ?>" alt="photo" class="slider__img pop-up-img">
                            ...
                            <div class="controls">
                                <div class="controls__arrows">
                                    ...
                                    <div id="slider-first_photo" class="controls__circle"></div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const firstSlider = document.querySelector('#slider-first_photo');
        firstSlider.click();
        let allItems = Array.from(ul.children);
        ...
        buttons.forEach(button => {
            button.addEventListener('click', function() {
                ...
                if (filter === 'all') {
                    ...
                    const filteredItems = allItems.filter(item => item.classList.contains(filter.substring(1)));
